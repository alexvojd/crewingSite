...
@section('content')
	<div class="table" style="position: relative;">
		<?echo Form::open(['route' => '/manager/search_resumes','class' => 'form-pad']); ?>
	...
	<table class=" table-striped table-bordered" style="position: relative;">
		...
		@foreach($resumes as $resume)
			<tr>
				...
				<td>
					<a href="/resume/{{$resume->id}}">{!! $resume->surname . " " . $resume->name . " " . $resume->patronymic !!}</a>
				</td>
				<td>
					{{$resume->birthDate}}
				</td>
